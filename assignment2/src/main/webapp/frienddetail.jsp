...
<c:if test="${not empty requestScope.friend}">
<ul class="list-group">
    <li class="list-group-item" text-align: center;>
        <img src="picture${requestScope.friend.picturepath}/photo.jpg?id=<%=new Date()%>"
             class="img-thumbnail" style="height:200px; width:200px"/>
    </li>
    <li class="list-group-item" text-align: center;>
        Name: ${requestScope.friend.name}
    </li>
    <li class="list-group-item" text-align: center;>
        Gender: ${requestScope.friend.gender}
    </li>
    <li class="list-group-item" text-align: center;>
        DoB: ${requestScope.friend.dateofbirth}
    </li>
    <li class="list-group-item" text-align: center;>
    Email: ${requestScope.friend.email}
    </li>
</ul>
</c:if>
</body>
