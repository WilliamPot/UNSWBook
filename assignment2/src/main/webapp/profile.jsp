...
<head>
    ...
    <style>
        ...
        .left{  width:25%; float:left;  text-align:left;}
        .right{  width:75%; float:right;  text-align:left;}
...
<ul class="list-group">
    <li class="list-group-item" text-align: center;>
        <div class="left">
        <img src="picture${sessionScope.user.picturepath}/photo.jpg?id=<%=new Date()%>"
             class="img-thumbnail" style="height:200px; width:200px"/></div>
        <div class="right">
        <form action="ChangePhotoServlet" method="post" enctype="multipart/form-data">
            <input type="file" name="photo" accept="image/*" required><br/>
            <button type="submit" title="Change my photo">Submit</button>
        </form>
        </div>
    </li>
    <li class="list-group-item" text-align: center;>
    ...
    <li class="list-group-item" text-align: center;>
        DoB: ${sessionScope.user.dateofbirth}
    </li>
    <li class="list-group-item" text-align: center;>
        <button  onclick="javascript:location.href='modifyprofile.jsp'">Modify</button>
        <button onclick="skipto()"/>Cancel</li>
    </li>
</ul>
<script>
    function skipto()
